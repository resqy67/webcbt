...
if ($pg == 'statusaktif') {
    $kode = $_POST['kode'];
    $query = mysqli_query($koneksi, "UPDATE siswa set status_siswa=1 where id_siswa in (" . $kode . ")");
    if ($query) {
        echo 1;
    } else {
        echo 0;
...
if ($pg == 'statusnonaktif') {
    $kode = $_POST['kode'];
    $query = mysqli_query($koneksi, "UPDATE siswa set status_siswa=0 where id_siswa in (" . $kode . ")");
    if ($query) {
        echo 1;
    } else {
        echo 0;
