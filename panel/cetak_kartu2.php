			...
			<td width='50%'>
				<div style='width:10.4cm;border:1px solid #666;'>
						...
						<tr>
							<td style="text-align:left; vertical-align:top">
								<?php
									...
									?>
								<img style="padding-left: 5px;" src='<?php echo '../dist/img/logo2.png'.'?date='.time(); ?> ?>' height='60px'>
							</td>
					...
					<table style="text-align:left; width:100%">
						<tr>
							<td class="ukuran"valign="top"> Nama Peserta: <b> <?= $siswa['nama'] ?></b></td>
						</tr>
					</table>
					<table style="text-align:left; width:100%">
						<tr>
							<td style="text-align:center; vertical-align:top; width:100px" rowspan="4">
								<?php
									if ($siswa['foto'] <> '') {
						...
						<tr>
							...
							<td class="ukuran" valign='top'>: <?= $siswa['ruang'] ?>
								<!--<div style="padding-top: <?= $setting['kartu_atas'].'px'; ?>; padding-left: <?= $setting['kartu_kiri'].'px'; ?>;" class="ttd"><img  src='<?php echo '../dist/img/ttttd.png'.'?date='.time(); ?> ?>' height='<?= $setting['kartu_tinggi'].'px'; ?>' width="<?= $setting['kartu_lebar'].'px'; ?>"></div>-->
							</td>
						</tr>
