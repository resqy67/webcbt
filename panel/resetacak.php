...
require("../config/functions.crud.php");
 ...
 /*
--mryesss
Untuk Mengacak Ulang 
Soal Siswa yang sedang aktif
...
$query = mysqli_query($koneksi, "UPDATE pengacak set id_soal='$id_soal',id_esai='$id_esai' where id_pengacak='$idpengacak'");
if ($query) {
    echo '1';
} else { }
