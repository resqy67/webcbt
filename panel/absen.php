...
<?php for ($i = 1; $i <= $n; $i++) : ?>
	...
	<?php if ($i == $n) : ?>
		<div class='page'>
			<table width='100%'>
				<tr>
					<td width='100'>
						<img src='<?php echo '../dist/img/logo2.png'.'?date='.time(); ?> ?>' height='80px'>
						<!-- <img src='../foto/logo_tut.svg' width='80'></td> -->
	...
	<div class='page'>
		<table width='100%'>
			<tr>
				<td width='100'><img src='../foto/dinas.png' width='80'></td>
				<td style="text-align:center">
					<strong class='f12'>
						DAFTAR HADIR PESERTA <BR>
						<?= strtoupper($setting['nama_ujian']) ?><BR>
