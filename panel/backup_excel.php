...
$spreadsheet->getProperties()
    ->setCreator("Kang")
    ->setLastModifiedBy("Kang")
    ->setTitle("Office 2007 XLSX for Asja")
    ->setSubject("Office 2007 XLSX for Asja")
    ->setDescription("Office 2007 XLSX for Asja")
    ->setKeywords("Office 2007 XLSX for Asja")
    ->setCategory("Office 2007 XLSX for Asja");
...
while ($data = mysqli_fetch_array($soal_mapel)) :
    ...
    $i++;
endwhile;
$spreadsheet->getActiveSheet()->setTitle('Kang Asja');
