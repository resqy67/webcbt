...
<div class='row'>
    <div class='col-md-12'>
        <div class='box box-solid'>
            ...
            <div class='box-body'>
                <div class="alert alert-warning" role="alert">Guru harus masuk ke room dahulu, agar siswa dapat melihat room tersebut. Pastikan Bpk/Ibu memiliki koneksi yang memadai atau stabil.
                </div>
                <div class="row">
                    <?php
