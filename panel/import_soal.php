<?php
defined('APLIKASI') or exit('Hayooo Mau Ngapain Bro ^_^!');
$id_mapel = $_GET['id'];
        ...
        <form id="formsoalcandy" method='post' enctype='multipart/form-data'>
            <div class='box box-solid'>
                ...
                <div class='box-footer'>
                    <a href='templete/importdatasoal.xls'><i class='fas fa-file-excel'></i> Download Format</a>
                </div>
            </div><!-- /.box -->
        </form>
    </div>
    <div class='col-md-6'>   <!--  -->
        <form id="formsoalword" action='<?= $homeurl ?>/panel/pages/word_import/import/index.php/word_import' method='post' enctype='multipart/form-data'>
            <div class='box box-solid'>
                <div class='box-header  bg-navy with-border'>
                ...
                <div class='box-footer'>
                    <a href='<?= $homeurl ?>/panel/pages/word_import/import/sample/formatsoal.docx'><i class='fas fa-file-word'></i> Download Format</a>
