				...
				<div class='box-body'>
					<table class='table table-bordered table-striped'>
						<tr>
							...
							<td style="text-align:center; width:150">Nilai ESSAI</td>
						...
						<tr>
							...
							<td width='10'>:</td>
							<td><?= $siswa['nama'] ?></td>
							<td rowspan='3' style='font-size:30px; text-align:center; width:150'><?= 	number_format($nilai['skor'], 2, '.', '');?></td>
							<td rowspan='3' style='font-size:30px; text-align:center; width:150'><?= 	number_format($nilai['nilai_esai'], 2, '.', ''); ?></td>
