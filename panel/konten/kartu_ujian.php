...
?>
	<?php if ($ac == '') : ?>
		...
		<iframe id='loadframe' name='frameresult' src='kartu_dena/cetak_kartu2.php' style='border:none;width:1px;height:1px;'></iframe>
<?php endif ?>
<script type="text/javascript">
	$(document).ready(function() {
	
		//function printkartu(idkelas, judul) { <?= $homeurl ?>
		function printkartu(idkelas,judul) {
		$('#loadframe').attr('src', 'kartu_dena/cetak_kartu2.php?id_kelas=' + idkelas);
		...
		$("#simpan_kartu").click(function() {
			...
			$.ajax({
				...
				data: 'jawab='+jawab+'&atas='+atas+'&kiri='+kiri,
